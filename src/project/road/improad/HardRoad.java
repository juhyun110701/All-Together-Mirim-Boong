...
public class HardRoad implements Road {
		//roadNum=4;	    
	    ...
	    private static final Texture BACKGROUND_DESERT = new Texture("img/garden.png");
	    private static final Texture BACKGROUND_SKY = new Texture("img/sky.png");
	    private static final Texture BACKGROUND_PYRAMID = new Texture("img/pyramid.png");
	    ...
	    public void resetRoad() {
	    	//add
//	    	for(int i=0; i<roadSegments.size();i++)  	roadSegments.remove(i);
//	    	RoadSegment resegment = findSegment(Math.round(position + PLAYER_Z));
//	    	for(int i = 0;i<resegment.getCars().size();i++) {
//	    		resegment.getCars().remove(i);
//	    	}
//	    	for(int i=0;i<resegment.getScenery().size();i++) {
//	    		resegment.getScenery().remove(i);
//	    	}
	    	player.setPlayer();
	    	//맵 add한대로 맵이 구성
	        RoadBuilder roadBuilder = new RoadBuilder()
	        		.addStart(RoadBuilder.Length.VSHORT)  //결승선
	                .addDip2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.HIGH)
	                .addHill2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.HIGH)
	                .addLeftCurve2(RoadBuilder.Length.MEDIUM, RoadBuilder.Curve.TIGHT, RoadBuilder.Hills.NONE)
	                .addDip2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.HIGH)
	                .addRightCurve2(RoadBuilder.Length.SHORT, RoadBuilder.Curve.MEDIUM, RoadBuilder.Hills.HIGH)
	                .addHill2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.HIGH)
	                .addLeftCurve2(RoadBuilder.Length.MEDIUM, RoadBuilder.Curve.TIGHT, RoadBuilder.Hills.LOW)
	                .addDip2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.HIGH)
	                .addRightCurve2(RoadBuilder.Length.LONG, RoadBuilder.Curve.TIGHT, RoadBuilder.Hills.NONE)
	                .addStraight2(RoadBuilder.Length.SHORT)
	                .addHill2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.HIGH)
	                .addDip2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.HIGH)
	                .addLeftCurve2(RoadBuilder.Length.SHORT, RoadBuilder.Curve.TIGHT, RoadBuilder.Hills.MEDIUM)
	                .addRightCurve2(RoadBuilder.Length.LONG, RoadBuilder.Curve.LIGHT, RoadBuilder.Hills.NONE)
	                .addLeftCurve2(RoadBuilder.Length.SHORT, RoadBuilder.Curve.TIGHT, RoadBuilder.Hills.LOW)
	                .addHill2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.HIGH)
	                .addRightCurve2(RoadBuilder.Length.LONG, RoadBuilder.Curve.LIGHT, RoadBuilder.Hills.NONE) //추가
	                .addStraight2(RoadBuilder.Length.SHORT)
	                .addDip2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.HIGH)
	                .addDip2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.HIGH)
	                .addDip2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.MEDIUM)
	                .addHill2(RoadBuilder.Length.SHORT, RoadBuilder.Hills.LOW) ;
	    ...
	    public void resetCars() {
	        ...
	        for (int n = 0; n < 7; n++) {
	            ...
	            speed = 1000F + (float) (MathUtils.random(2000, 9000));
	   ...
	   //@Override
	    ...
	    public void render(Camera camera) {
	        ...
	        polygonSpriteBatch.draw(BACKGROUND_DESERT, 0, 0, BACKGROUND_DESERT.getWidth(), HEIGHT);
	        polygonSpriteBatch.draw(BACKGROUND_PYRAMID, 0, 0, BACKGROUND_PYRAMID.getWidth(), HEIGHT);
...
//	            render roadside sprites
	    ...
	    private void renderScenery(Scenery scenery, float scale, float destX, float destY, float clipY) {
	        ...
	        scenery.draw(polygonSpriteBatch, destX, destY, destW, destH, percentageToDraw,0);
	    }
